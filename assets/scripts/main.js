...
const router = new Router(function () {
   ...
   */
  let rcElement = document.querySelector('.section--recipe-cards'); 
  let reElement = document.querySelector('.section--recipe-expand'); 
  rcElement.classList.add('shown'); 
  reElement.classList.remove('shown'); 
});
